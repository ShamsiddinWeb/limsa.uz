      ...
      <div className="container">
        <div className="hero__content">
          <div className="hero__left" data-aos="fade-down">
            ...
            <button className="hero__button" aria-label={props.t("header__link4")}>
          ...
          <div className="hero__right" data-aos="fade-down">
            <div className="hero__card">
              <a href="https://www.ataevbahodirbuild.uz/" aria-label="Visit AB Build" rel="noopener noreferrer" target="_blank">
                <img src={abBuild} alt="AB Build" loading="lazy" />
              </a>
              <a href="https://www.homekit.uz/" aria-label="Visit Homekit" rel="noopener noreferrer" target="_blank">
                <img src={homekit} alt="Homekit" loading="lazy" />
              </a>
              <a href="https://www.it-time-academy.uz/" aria-label="Visit IT Time" rel="noopener noreferrer" target="_blank">
                <img src={itTime} alt="IT Time" loading="lazy" />
              </a>
            </div>

            <div className="hero__card">
              <a href="https://www.uzloyal.uz/" aria-label="Visit Loyal Website" rel="noopener noreferrer" target="_blank">
                <img src={loyalWebsite} alt="Loyal Website" loading="lazy" />
              </a>
              <a href="https://www.autozoomrental.com/" aria-label="Visit Avtozoom" rel="noopener noreferrer" target="_blank">
                <img src={avtozoomWeb} alt="Avtozoom" loading="lazy" />
              </a>
              <a href="https://www.namanganoits.uz/" aria-label="Visit Noits" rel="noopener noreferrer" target="_blank">
                <img src={noits} alt="Noits" loading="lazy" />
              </a>
            </div>

            <div className="hero__card">
              <a href="https://propartnyor.uz/" aria-label="Visit Propartnyor" rel="noopener noreferrer" target="_blank">
                <img src={propartnyor} alt="Propartnyor" loading="lazy" />
              </a>
              <a href="https://zamontour.uz/" aria-label="Visit Zamon Tour" rel="noopener noreferrer" target="_blank">
